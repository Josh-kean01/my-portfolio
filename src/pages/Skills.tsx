    ...
    <div className="px-6 py-24 md:px-12 lg:px-16 max-w-7xl mx-auto animate-fade-in-up">
      ...
      <div className="mt-24 text-center md:text-left">
        <div className="relative inline-block group cursor-pointer">
          ...
          <a href="../adekunle-joshua-resume.pdf" download target="_blank" className="relative block bg-primary text-white dark:bg-white dark:text-primary px-10 py-4 text-sm uppercase tracking-widest font-bold border border-transparent hover:shadow-xl transition-all duration-300">
